...
workflow merge_vcfs {
    ...
    .set { ch_to_filter }
    COMMON_FILTER_VCF(ch_to_filter)

    // Do the merge
    ch_cfilter_out_file1 = COMMON_FILTER_VCF.out.filter { it[1] == "file1" }
    ch_cfilter_out_file2 = COMMON_FILTER_VCF.out.filter { it[1] == "file2" }
